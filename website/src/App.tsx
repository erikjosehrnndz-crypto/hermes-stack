  ...
  return (
    <div>
        ...
        <div className="container">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <div className="hero-actions">
              ...
              <a className="btn-secondary" href="https://github.com/erikjosehrnndz-crypto/hermes-stack" target="_blank" rel="noreferrer">
      ...
      <footer className="footer">
        <div className="container">
          <p>© {new Date().getFullYear()} Hermes Stack · Desarrollado por <a href="https://github.com/erikjosehrnndz-crypto" target="_blank" rel="noreferrer">Erik José Hernández</a></p>
        </div>
      </footer>
    </div>
  );
